...
async function refrescarReanalisis(){
 ...
 try{
  ...
  $('reanalisar-foto').disabled=enviandoReanalisis||!!v.activo||!!v.reserva_incierta_usd||!!v.bloqueo||sinPresupuesto||!original(id);
