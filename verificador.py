...
- volquete_mal_dispuesto: un VOLQUETE de obra (caja metálica abierta para escombros, distinta de los contenedores municipales de basura) abandonado o MAL dispuesto: DESBORDADO (los residuos llegan o superan el borde superior), atravesado en la calzada (no paralelo al cordón), ubicado en una bocacalle u ochava, sobre una rampa para personas con discapacidad, una senda peatonal o un sumidero, sobre la vereda sin dejar ~1,5 m de paso peatonal, o visiblemente abandonado (oxidado, tapado de basura variada). Un volquete BIEN ubicado (paralelo al cordón, sin desbordar, con paso libre) NO es un problema: no lo reportes. El contenedor de obra verde NO es contenedor_secos.
