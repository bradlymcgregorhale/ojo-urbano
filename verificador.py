...
Gravedad por categoría (no aplica a las claves [PRESENCIA]): 1 mínima (apenas presente, incidental) · 2 leve · 3 alta · 4 grave · 5 muy grave. Calibración para recoleccion (sé exigente): 1-2 = una bolsa sola o poca basura aislada; 3 = basura claramente presente pero acotada (algunas cajas y restos junto al contenedor); 4 = mucha basura variada ocupando un área notable; 5 = acumulación masiva cubriendo la vereda. Calibración para retiro_muebles: 1-2 = un objeto pequeño o poco invasivo; 3 = un objeto grande (por ejemplo una alfombra enrollada) o varios objetos menores; 4 = varios voluminosos o una acumulación que ocupa un área notable de paso; 5 = acumulación masiva que bloquea la vereda.
...
{"revision_bolsas": "pasada bolsa por bolsa: qué grupos hay y qué señales tienen", "categorias": [{"key": "...", "gravedad": 1-5, "evidencia": "qué se ve, máx 10 palabras"}], "sin_problema": true|false, "descripcion": "1-2 frases sobre qué se ve en la foto"}"""
