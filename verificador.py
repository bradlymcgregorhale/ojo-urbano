...
Decidí solo por lo que VES. Respondé SOLO con JSON válido: {"hay_estructura": true|false, "veredicto": "base_de_contenedor" | "objeto_descartado" | "indeterminado", "evidencia": "qué viste, máx 15 palabras"}"""
    ...
    if REPREGUNTA_OBJETOS and activos and len(VERIFICADORES) >= 3:
        ...
        _desc_cont = {
            ...
            "contenedor_humedos_lateral":
                "NEGRO u oscuro, del tipo con postes metálicos de izado",
            "contenedor_humedos_bilateral":
